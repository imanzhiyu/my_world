// /**
//  * @FilePath: static/js/private_check.js
//  * @Author: Joel
//  * @Date: 2025-08-21 18:50:22
//  * @LastEditTime: 2025-08-21 19:06:15
//  * @Description:
//  */
...
document.addEventListener("DOMContentLoaded", () => {
    ...
    if (!privateContent || !passwordModal) return;
    ...
    fetch("/private/check", {
        method: "GET",
        headers: {"X-Private-Session": sessionId}
    })
        .then(res => res.json())
        .then(data => {
            if (data.access) {
